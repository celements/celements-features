...
public class CelSendMail implements IMailObjectRole {
  ...
  public void setHtmlContent(String htmlContent, boolean isLatin1) {
    ...
    if ((getMailObject().getTextPart() == null) || "".equals(
      ...
      stringBuilder.append(getContext().getMessageTool().get("cel_plain_text_mail"));
      stringBuilder.append("\r\n\r\n");
      stringBuilder.append(Jsoup.parse(htmlContent).text());
      getMailObject().setTextPart(stringBuilder.toString());
    }
  }
